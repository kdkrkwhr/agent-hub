...
> **0.1.0 Alpha** · Windows 중심으로 검증했습니다. 캡처는 예시 데이터로 구성한 화면입니다.

## 주요 기능

### 대화와 토론

각자 독립 의견을 준비한 뒤 필요한 쟁점만 토론합니다. 최종안은 작성자를 제외한 동료가 검토합니다. 독립 비밀 투표, 채널 보관·복구, 토론 Markdown 내보내기도 지원합니다.
...
![사무실 화면 — 확장 이전 예시](docs/screenshots/office.png)
